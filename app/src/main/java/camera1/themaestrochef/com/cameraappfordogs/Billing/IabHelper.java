...
public class IabHelper {
    ...
    public void queryInventoryAsync(boolean b, List<String> skuList, QueryInventoryFinishedListener listener)
            throws IabAsyncInProgressException{
    ...
    public String getPricesDev(String packageName, String productSKU) throws RemoteException, JSONException{
        ...
        if (response == 0) {
            ...
            for (String thisResponse : responseList) {
                ...
                if(sku.contains(productSKU)) return price;
    ...
    public String getDescription(String packageName, String productSKU) throws RemoteException, JSONException{
        ...
        if (response == 0) {
            ...
            for (String thisResponse : responseList) {
                JSONObject object = new JSONObject(thisResponse);
                String sku = object.getString("productId");
                String price = object.getString("description");
